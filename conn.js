...
const donat = {key : {participant : '0@s.whatsapp.net', ...(from ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `TYPES PAYMENTS [ Baphomate MD ] : ✓`,jpegThumbnail: fs.readFileSync('./img/mod.jpg')}}}
//Resize
...
case 'speedbot': case 'speed':
        ...
        if (stderr.trim()) reply(stderr)
            ...
            let own = sinting.ownerNumber
                ...
                conn.sendMessage(from, { image: budy, caption: `${own} \n\nini owner aku kak jan lupa save ya`,contextInfo:{"externalAdReply": {"title": `SC © °Dark`,"body": `Selamat ${ucapanWaktu}`,
previewType: "PHOTO",
...
break
case 'p':
conn.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true, title: `${ucapanWaktu}`, body:`Bot aktif ${runtime(process.uptime())}`, previewType:"PHOTO", thumbnail: fs.readFileSync('./img/mod.jpg'), sourceUrl:`https://xnxx.com/TobatBro`}}, text: `*APA MAS BRO🗿*`}, { quoted: kaflo})
