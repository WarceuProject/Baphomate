...
'TEL;type=CELL;type=VOICE;waid=6285691724140:+6285691724140\n' +
'END:VCARD'
prefix = '#'
blockcall = false
...
├  Lib : Baileys
└  Creator : R4id3n`
client.sendMessage(from, { text: menu, jpegThumbnail: fs.readFileSync('./image/anjay.jpeg')}, 'extendedTextMessage', { quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [me] }})
             break
				case 'info':
					me = client.user
