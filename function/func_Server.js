...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === bp.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = bp.user.id.split(':')[0]+'@s.whatsapp.net'
}
