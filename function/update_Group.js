...
const updateGroup = async (bp, anu, MessageType) => {

const metdata = await bp.groupMetadata(anu.jid)
...
bp.sendMessage(metdata.id, teks, MessageType.text, {quoted: fkontakk})
...
bp.sendMessage(metdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [tag]}, quoted: fkontakk})
